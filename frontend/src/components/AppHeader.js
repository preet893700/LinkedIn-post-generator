  ...
  return (
    <div className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between sticky top-0 z-50">
      <div className="flex items-center gap-2 cursor-pointer" onClick={() => navigate('/')}>
        ...
        <span className="font-bold text-xl text-gray-900">Free LinkedIn Post Generator</span>
      </div>
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        >
          <div className="w-9 h-9 bg-purple-600 text-white rounded-full flex items-center justify-center font-semibold">
            {user?.avatar_url ? (
